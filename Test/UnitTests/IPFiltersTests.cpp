...
namespace UnitTests
{
	...
	public:
		TEST_METHOD(AddRemove)
		{
			...
			Assert::AreEqual(static_cast<size_t>(0), ipfilters.GetFilters().Value().size());
			...
			Assert::AreEqual(static_cast<size_t>(3), ipfilters.GetFilters().Value().size());
		...
		TEST_METHOD(General)
		{
			...
			Assert::AreEqual(false, ipfilters.IsAllowed(L"192.168.0.1").Value());
			Assert::AreEqual(false, ipfilters.IsAllowed(L"192.168.0.10").Value());
			Assert::AreEqual(false, ipfilters.IsAllowed(L"192.168.0.200").Value());

			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef10:e795").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"192.168.1.2").Value());

			auto result2 = ipfilters.AddFilter(L"192.168.1.2", L"255.255.255.255", IPFilterType::Blocked);
			Assert::AreEqual(true, result2.Succeeded());

			Assert::AreEqual(false, ipfilters.IsAllowed(L"192.168.1.2").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"192.168.1.1").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"192.168.1.100").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"192.200.1.100").Value());
			...
			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef10:e795").Value());
			...
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:eeee:e795").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:eeef:e795").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef0f:e795").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef09:e795").Value());

			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef10:e795").Value());

			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef11:e795").Value());
			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef12:e795").Value());
			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef20:e795").Value());
			Assert::AreEqual(false, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef33:e795").Value());
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef34:e795").Value());
		...
		TEST_METHOD(AllowOverride)
		{
			...
			Assert::AreEqual(false, ipfilters.IsAllowed(L"192.168.0.100").Value());
			...
			Assert::AreEqual(true, ipfilters.IsAllowed(L"192.168.0.100").Value());
			...
			Assert::AreEqual(true, ipfilters.IsAllowed(L"fe80::c11a:3a9c:ef12:e795").Value());
		}
	};
}