...
extern "C" {
#endif
int crypto_kem_newhope_keypair(unsigned char *pk, unsigned char *sk);

int crypto_kem_newhope_enc(unsigned char *ct, unsigned char *ss, const unsigned char *pk);

int crypto_kem_newhope_dec(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
#ifdef __cplusplus
}
#endif
